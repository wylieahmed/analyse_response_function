function reanalyse_preprocessed_data_folder_3_almost_dead(path)
...
for i=1:length(files)
    ...
    for j=1:length(response)
        ...
        [res,f,res_all_x,res_all_y,xy_k_extract,fbl,Pbl,k_fit]=process_response_data_plus_trap_calibration(p)
